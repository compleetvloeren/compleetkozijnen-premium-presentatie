...
De 5-kamer technologie in combinatie met het 3-dichting systeem zorgt voor uitstekende isolatiewaarden, terwijl de STV® lijmtechniek een levenslange verbinding tussen glas en profiel garandeert.`,
    ...
    advantages: [
      {
        ...
        description: 'Uitstekende thermische prestaties door 5-kamer technologie'
      },
      {
        icon: Shield,
        title: 'Duurzaam & Veilig',
        description: 'GEALAN-ACRYLCOLOR® coating voor langdurige bescherming'
      },
      {
        icon: Droplets,
        title: 'Waterdicht',
        description: '3-dichting systeem biedt maximale bescherming tegen weersinvloeden'
      },
      {
        icon: Wind,
        title: 'Windbestendig',
        description: 'Robuuste constructie bestand tegen Nederlandse weersomstandigheden'
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <link rel="canonical" href="https://compleetkozijnen.nl/producten/s9000-base" />
      </Helmet>
      <Navigation />
