...
Met zijn unieke combinatie van 4° en 15° schuintes creëert dit systeem een authentieke Nederlandse uitstraling die zowel traditionalisten als liefhebbers van moderne prestaties zal aanspreken. Het systeem is geoptimaliseerd voor Nederlandse bouwvoorschriften en weersomstandigheden.`,
    ...
    advantages: [
      {
        icon: Home,
        title: 'Authentiek Nederlands',
        description: 'Perfect geïntegreerd in traditionele Nederlandse architectuur'
      },
      {
        icon: Shield,
        title: 'Klassiek & Modern',
        description: 'Traditionele uitstraling met moderne isolatietechnologie'
      },
      {
        icon: Droplets,
        title: 'Nederlandse Omstandigheden',
        description: 'Speciaal ontwikkeld en getest voor het Nederlandse klimaat'
      },
      {
        icon: Wind,
        title: 'Bewezen Betrouwbaarheid',
        description: 'Jarenlange ervaring in Nederlandse woningbouw'
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <link rel="canonical" href="https://compleetkozijnen.nl/producten/s9000-styl" />
      </Helmet>
      <Navigation />
